...
class HealthService {
  ...
  Future<void> syncWaterReminders({required bool enabled, required int intervalHours, required String? wakeTime, required String? sleepTime, required int currentWaterMl,
    required int goalWaterMl,}) async {
