          ...
          child: Column(
            ...
            children: [
              ...
              ZoneDetailCard(
                ...
                percentage: '50% - 60%',
                description:
                    'Lý tưởng để khởi động, phục hồi sau tập luyện hoặc cho người mới bắt đầu.',
              ...
              ZoneDetailCard(
                ...
                percentage: '60% - 70%',
                description:
                    'Tốt nhất để giảm cân và tăng cường sức bền cơ bản. Cơ thể sử dụng chất béo làm nguồn năng lượng chính.',
              ...
              ZoneDetailCard(
                ...
                percentage: '70% - 80%',
                description:
                    'Cải thiện hệ thống tim mạch và hô hấp. Tăng cường khả năng vận chuyển oxy đến cơ bắp.',
              ...
              ZoneDetailCard(
                ...
                percentage: '80% - 90%',
                description:
                    'Tăng cường sức mạnh và tốc độ. Cải thiện khả năng chịu đựng của cơ bắp với axit lactic.',
              ...
              ZoneDetailCard(
                ...
                percentage: '90% - 100%',
                description:
                    'Nỗ lực tối đa trong thời gian ngắn. Chỉ dành cho vận động viên chuyên nghiệp hoặc các bài tập HIIT cường độ cực cao.',
