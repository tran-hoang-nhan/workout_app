class LabelUtils {
  static String getGenderLabel(String? gender) => switch (gender?.toLowerCase()) {
    'male'   => 'Nam',
    'female' => 'Nữ',
    null     => 'Chưa cập nhật',
    _        => gender!, 
  ...
  static String getActivityLevelLabel(String? level) => switch (level?.toLowerCase()) {
  ...
  static String getDietTypeLabel(String? dietType) => switch (dietType?.toLowerCase()) {
    'normal'     => 'Bình thường',
    'vegetarian' => 'Chay',
    'vegan'      => 'Thuần chay',
    'keto'       => 'Keto',
