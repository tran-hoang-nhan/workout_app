...
final registrationTransactionServiceProvider =
    Provider<RegistrationTransactionService>((ref) {
      return RegistrationTransactionService();
    });

final registrationTransactionProvider =
    AsyncNotifierProvider<RegistrationTransactionController, void>(() {
